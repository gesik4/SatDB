...
rails generate model Memory manufacturer:string volume:float reservation:??? storage_life:float throughput:float channel_number:integer lifetime:float cost:float --no-test-framework
